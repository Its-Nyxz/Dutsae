<div class="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-100 p-4 sm:p-6 space-y-4 sm:space-y-6 font-sans transition-colors duration-200">
    ...
    <!-- Header Banner -->
    <div class="bg-white dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-850 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-sm dark:shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 transition-colors">
        <div>
            <h1 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight">Dashboard Operasional Toko Besi</h1>
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5 sm:mt-1">Ringkasan Omzet, Uang Masuk, Transaksi & Alert Persediaan Stok</p>
        </div>
        <a href="{{ route('pos') }}" class="w-full sm:w-auto justify-center bg-amber-500 hover:bg-amber-600 text-slate-950 font-black px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-xl shadow-lg transition flex items-center gap-2 text-sm sm:text-base">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-xl space-y-2.5 transition-colors">
            ...
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Total nilai faktur penjualan hari ini</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-xl space-y-2.5 transition-colors">
            ...
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Kas/transfer nyata diterima hari ini</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-xl space-y-2.5 transition-colors">
            ...
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Penjualan selesai hari ini</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-xl space-y-2.5 transition-colors">
            ...
            <div class="text-2xl sm:text-3xl font-black text-purple-600 dark:text-purple-400 font-mono">
                Rp {{ number_format($averageTransactionValue, 0, ',', '.') }}
            </div>
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Per transaksi penjualan</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <!-- Low Stock Alert Box -->
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-xl space-y-4 transition-colors">
